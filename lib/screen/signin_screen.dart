...
class _Controller {
  ...
  void signIn() async {
    ...
    try {
      ...
      MyDialog.info(
          context: state.context, title: 'Sign In Error', content: e.toString());
      return;
    }
    ...
    try {
      ...
      Navigator.pushNamed(state.context, UserHomeScreen.routeName, arguments: {
        ...
        Constant.ARG_NOTIFICATION_COMMENT_LIST: notificationCommentList,
      });
    } catch (e) {
      MyDialog.circularProgessStop(state.context);
      MyDialog.info(
